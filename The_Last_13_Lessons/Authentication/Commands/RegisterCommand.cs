...
namespace Authentication.Commands
{
    public class RegisterCommand
    {
        ...
        public void Handle(User database)
        {
        ...
        private string GetAndValidateEmail(List<User> users)
        {
            ...
            while (true)
            {
                ...
                ///Way 1 ==> Eger contains ederse,emailde user movcud olmazsa eksi olsun 
                //if (_utility.Contains(email, AT_SIGN) && !IsEmailExists(users, email))
                //    return email;

                ///Way2 ==> Mesajlar ferqli ferlqi gosterilende eger movcud deyilse emailin sisteme yeniden qayidir...
        ...
        public bool IsValidName(string name, int minLength, int maxLenght)
        {
